  ...
  parse: function(metadata) {
    ...
    if(metadata.regionType !== undefined) {
      var // Region Area
        ...
        y = parseField(metadata.regionAreaY),
        w = parseField(metadata.regionAreaW),
        h = parseField(metadata.regionAreaH),
        unit = parseField(metadata.regionAreaUnit),
        // Region
        types = parseField(metadata.regionType)
        names = parseField(metadata.regionName);
